...
2. [**Windows OS Secure Configuration (Guest Account Group Membership)**](https://github.com/SamuelSor/Cyber-Security/blob/main/Automation/Windows-Automation/guest-account-toggle.ps1)
...
**Samuel Sorto, Security Analyst**<br/>
